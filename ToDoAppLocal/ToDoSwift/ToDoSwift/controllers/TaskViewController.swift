...
class TaskViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let task = self.task{
            ...
            self.prioritySegmentControl.selectedSegmentIndex = Int(task.priority)
    ...
    @IBAction func ok(_ sender: Any) {
        if let task = self.task{
            ...
            task.priority = Int32(prioritySegmentControl.selectedSegmentIndex)
            ...
            newTask.priority = Int32(self.prioritySegmentControl.selectedSegmentIndex)
